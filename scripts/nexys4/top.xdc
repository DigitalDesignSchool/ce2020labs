...
set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS33} [get_ports {key_sw[0]}]
...
set_property -dict {PACKAGE_PIN V10 IOSTANDARD LVCMOS33} [get_ports {key_sw[2]}]
...
set_property -dict {PACKAGE_PIN P17 IOSTANDARD LVCMOS33} [get_ports key_sw[3]]
set_property -dict {PACKAGE_PIN M17 IOSTANDARD LVCMOS33} [get_ports key_sw[1]]
