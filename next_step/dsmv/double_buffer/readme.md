# Пример double_buffer

## Назначение

Пример демонстрирует работу классической реализации двойного буфера 

## Структурная схема

![struct](./doc/struct_double_buffer.png)
...
В данном примере используется классическая реализации двойного буфера.
